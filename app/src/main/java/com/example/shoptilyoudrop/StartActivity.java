...
public class StartActivity extends AppCompatActivity {
    ...
    private static final String TAG2 = "StartActivity";
    ...
    public void onStart() {
        ...
        if (currentUser != null) {
            Log.d(TAG2, "Currently Signed in: " + currentUser.getEmail());
    ...
    private void launchMenuActivity(FirebaseUser user) {
        if (user != null) {
            MenuActivity.startActivity(this, user.getDisplayName());
            finish();
        }
    }
    ...
    private void updateUI(FirebaseUser fUser){
        ...
        if(account !=  null){
            ...
            Toast.makeText(StartActivity.this,personName + personEmail ,Toast.LENGTH_SHORT).show();
        }
